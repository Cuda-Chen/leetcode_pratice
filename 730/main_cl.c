...
int countPalindromicSubsequences(char * S){
    ...
    // build program
    err = clBuildProgram(program, 1, &device_id, "-g", NULL, NULL);
    if(err != CL_SUCCESS)
    {
...
#define TEST_CASES_ITER \
    /*TEST_IMPL("bccb") \
    TEST_IMPL("bccbbccb") \
    TEST_IMPL("abcdabcdabcdabcdabcdabcdabcdabcddcbadcbadcbadcbadcbadcbadcbadcba") */\
    TEST_IMPL("")
